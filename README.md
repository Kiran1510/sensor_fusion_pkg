...
| `/vertical_velocity` | `std_msgs/Float32` | Publisher | Estimated vertical velocity (in m/s) |
| `/vertical_velocity/depth` | `std_msgs/Float32` | Publisher | Raw depth derived velocity (in m/s), for comparison |
| `/vertical_velocity/imu` | `std_msgs/Float32` | Publisher | Raw IMU integrated velocity (in m/s), for comparison |
...
mkdir -p ~/ros2_ws/src
cd ~/ros2_ws/src
git https://github.com/Kiran1510/sensor_fusion_pkg
cd ~/ros2_ws
